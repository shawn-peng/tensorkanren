...
>>> from mykanren import run, var, fact
...
def makeops(op, lists):
    ...
    >>> from mykanren.assoccomm import makeops
...
def partition(tup, part):
    ...
    >>> from mykanren.assoccomm import partition
...
def groupsizes_to_partition(*gsizes):
    """
    >>> from mykanren.assoccomm import groupsizes_to_partition
...
def eq_assoc(u, v, eq=core.eq, n=None):
    ...
    >>> from mykanren import run, var, fact
    >>> from mykanren.assoccomm import eq_assoc as eq
...
def eq_comm(u, v, eq=None):
    ...
    >>> from mykanren import run, var, fact
    >>> from mykanren.assoccomm import eq_comm as eq
    >>> from mykanren.assoccomm import commutative, associative
...
def eq_assoccomm(u, v):
    ...
    >>> from mykanren.assoccomm import eq_assoccomm as eq
    >>> from mykanren.assoccomm import commutative, associative
    >>> from mykanren import fact, run, var
